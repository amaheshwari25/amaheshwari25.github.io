...
<div class="projects-container">
  ...
  <div class="project">
    <div class="project-header" id="project-matroids">
      ...
      <span class="project-title">1. Sample Complexity for Black-box Reductions in Mechanism Design <a href="../assets/pdf/EC25_Poster.pdf" target="_blank">[poster]</a> </span>
    </div>
  ...
  <div class="project">
    ...
    <div class="details" style="display: none;">
      ...
      <p>I worked on this project with Prof. István Miklós (Rényi Institute) and two other students while at the Budapest Semesters in Mathematics in 2024.</p>
    </div>
  </div>
  <div class="project">
